  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        <h1
          className="text-4xl fixed left-0 top-0 flex w-full justify-center border-b
         border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 
        ...
        <div className="fixed bottom-10 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          Challenge by
          <a href="https://industria4.tech" target="_blank">
            industria4.tech
          </a>
          . Coded by
          <a href="https://github.com/JonatanGarbuyo" target="_blank">
            Jonatan Garbuyo
          </a>
          .
        </div>
      ...
      after:w-[340px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200
